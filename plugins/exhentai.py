...
from seleniumwire import webdriver as webdriver1
...
class exhentai:
	def load(self, getUrl=''):
		...
		eHentai_Username.send_keys("Enter your Username Here!") # Username
		eHentai_Password.send_keys("And your Password!") # Password
		...
		getFullHTML = BeautifulSoup(eHentai_Login.page_source, features="lxml")
		temp["Title"] = getFullHTML.find(id="gn").getText()
